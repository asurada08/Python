...
def playGame():
    ...
    r = random.randrange(0,256); g = random.randrange(0,256); b = random.randrange(0,256)
    ...
    monsterX = 0
    monsterY = random.randrange(0, int(swidth * 0.3)) # 상위 30% 위치 까지만
...
monsterImage = ['img/monster01.png', 'img/monster02.png', 'img/monster03.png', 'img/monster04.png', 'img/monster05.png', 'img/monster06.png', 'img/monster07.png', 'img/monster08.png', 'img/monster09.png', 'img/monster10.png']
monster = None # 우주괴물
missile = None # 미사일
